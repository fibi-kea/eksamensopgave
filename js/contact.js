...
async function hentJson() {
	...
	let jsonData = await fetch("http://imkennykennedy.com/kea/2_semester/tema_eksamen/wordpress/wp-json/wp/v2/pages/737");
	...
	dest.querySelector("[data-title]").textContent = side.title.rendered;
}
